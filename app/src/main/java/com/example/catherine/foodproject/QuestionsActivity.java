...
public class QuestionsActivity extends AppCompatActivity {
    ...
    TextView tvShowC,tvShowF,tvShowR;
...
//        tvShowC = findViewById(R.id.tvShowC);
//        tvShowF = findViewById(R.id.tvShowF);
//        tvShowR = findViewById(R.id.tvShowR);
...
//        if(cuisineMsg.length()>0) {
//            tvShowC.setText(cuisineMsg);
//        }
//        if(foodMsg.length()>0) {
//            tvShowF.setText(foodMsg);
//        }
